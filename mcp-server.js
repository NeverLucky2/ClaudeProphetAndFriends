...
import { MARKET_HOLIDAYS } from './agent/market-calendar.js';
import {
...
`;
      ...
      case 'get_datetime': {
        ...
        try {
          ...
          // Full-close NYSE holidays — single source of truth in agent/market-calendar.js
          const isHoliday = MARKET_HOLIDAYS.has(isoDate);
